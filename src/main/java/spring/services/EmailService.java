...
public class EmailService {
    ...
    @Autowired
    private JavaMailSender mailSender; //see root-context.xml

    @Autowired
    private VelocityEngine velocityEngine; //see root-context.xml
        ...
        try {
            MimeMessagePreparator preparator = new MimeMessagePreparator() {
                ...
                public void prepare(MimeMessage mimeMessage) throws Exception {
                    String from = (String) model.get(TO);
                    String to = (String) model.get(FROM);
                  ...
                  //  message.setReplyTo("Egorpyp@gmail.com");
                    if (bccList != null) {
